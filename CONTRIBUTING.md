...
For a comprehensive guide to the GRP archive determinism contract, including binary format specifications, invariants, verification procedures, and testing strategies, see [docs/GRP_DETERMINISM.md](docs/GRP_DETERMINISM.md).
