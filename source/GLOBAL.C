...
int32_t ctf_ghost_target_x = 53072; /* Flag 4 teleport destination X (synced at  */
int32_t ctf_ghost_target_y = 3072;  /* level load to the real ghost sector; these */
int32_t ctf_ghost_target_z = -6144; /* defaults match CTF1.MAP as a safe fallback */
int32_t ctf_timer_target_x = 21760; /* Flag 3 SAFE timer-room point (a corner,   */
int32_t ctf_timer_target_y = 1280;  /* off the hostile centre boss — see CTF-2). */
int32_t ctf_vault_target_x = 35840; /* Flag 5 vault-room centre. Both synced at   */
int32_t ctf_vault_target_y = 5120;  /* level load to the real sectors (G1-A).     */
