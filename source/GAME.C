...
void Logo(void)
{
    ...
    clearview(0L);
    rotatesprite(160<<16,200<<15,65536L,0,MENUSCREEN,16,0,10+64,0,0,xdim-1,ydim-1);
    printext256(60, 40, 31, -1, "DUKE NUKEM 3D", 0);
    printext256(52, 56, 23, -1, "MODERN SOURCE PORT", 0);
    ...
    clearview(0L);
    rotatesprite(160<<16,200<<15,65536L,0,MENUSCREEN,16,0,10+64,0,0,xdim-1,ydim-1);
    printext256(36, 30, 31, -1, "== DUKE NUKEM 3D ==", 0);
    ...
    printext256(40,108, 12, -1, "GAME BY 3D REALMS (1996)", 0);
