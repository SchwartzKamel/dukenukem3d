...
void Logo(void)
{
    ...
    clearview(0L);
    rotatesprite(160<<16,200<<15,65536L,0,MENUSCREEN,16,0,10+64,0,0,xdim-1,ydim-1);
    minitext(136, 40, "ATOMIC SHELL", 0, 2+8+16+128);
    minitext(120, 56, "GAME HACKING VILLAGE", 0, 2+8+16+128);
    minitext(108, 80, "ALL ASSETS GENERATED BY AI", 0, 2+8+16+128);
    minitext(120, 96, "NO ORIGINAL ART USED", 0, 2+8+16+128);
    minitext(108,120, "MAPS / TEXTURES / SOUNDS /", 0, 2+8+16+128);
    minitext(118,132, "PALETTES / ANIMATIONS", 0, 2+8+16+128);
    minitext(104,156, "BUILT WITH LLMs + FLUX.2-PRO", 0, 2+8+16+128);
    minitext(128,180, "PRESS ANY KEY...", 0, 2+8+16+128);
    nextpage();
    ...
    clearview(0L);
    rotatesprite(160<<16,200<<15,65536L,0,MENUSCREEN,16,0,10+64,0,0,xdim-1,ydim-1);
    gametext(160, 26, "ATOMIC SHELL", 0, 2+8+16);
    gametext(160, 50, "NEON NOIR PORT", 0, 2+8+16);
    gametext(160, 78, "ENGINE BY KEN SILVERMAN", 0, 2+8+16);
    gametext(160,100, "PRESENTED BY LAFIAMAFIA", 0, 2+8+16);
    gametext(160,128, "NO COPYRIGHTED ASSETS USED", 0, 2+8+16);
    gametext(160,160, "PRESS ANY KEY", 0, 2+8+16);
