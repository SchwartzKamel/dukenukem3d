...
void Logo(void)
{
    ...
    clearview(0L);
    rotatesprite(160<<16,200<<15,65536L,0,MENUSCREEN,16,0,10+64,0,0,xdim-1,ydim-1);
    printext256(60, 40, 31, -1, "ATOMIC SHELL", 0);
    printext256(52, 56, 23, -1, "GAME HACKING VILLAGE", 0);
    printext256(28, 80, 31, -1, "ALL ASSETS GENERATED BY AI", 0);
    printext256(52, 96, 12, -1, "NO ORIGINAL ART USED", 0);
    printext256(24,120, 23, -1, "MAPS / TEXTURES / SOUNDS /", 0);
    printext256(24,132, 23, -1, "PALETTES / ANIMATIONS", 0);
    printext256(20,156, 14, -1, "BUILT WITH LLMs + FLUX.2-PRO", 0);
    printext256(60,180,  8, -1, "PRESS ANY KEY...", 0);
    nextpage();
    ...
    clearview(0L);
    rotatesprite(160<<16,200<<15,65536L,0,MENUSCREEN,16,0,10+64,0,0,xdim-1,ydim-1);
    printext256(36, 30, 31, -1, "== ATOMIC SHELL ==", 0);
    printext256(72, 50, 23, -1, "NEON NOIR PORT", 0);
    printext256(56, 76, 14, -1, "100%% AI GENERATED", 0);
    printext256(16, 96, 12, -1, "ORIGINAL ENGINE BY KEN SILVERMAN", 0);
    printext256(40,108, 12, -1, "PRESENTED BY LAFIAMAFIA", 0);
    printext256(20,132,  8, -1, "THIS PORT USES NO COPYRIGHTED", 0);
    printext256(20,144,  8, -1, "ASSETS. ALL CONTENT PROCEDURAL", 0);
    printext256(20,156,  8, -1, "OR LLM/DIFFUSION GENERATED.", 0);
    printext256(60,180, 31, -1, "PRESS ANY KEY...", 0);
