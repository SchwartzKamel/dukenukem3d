...
| **Audio Stub Struct Safety** | Added 24+ `_Static_assert()` size guarantees in `compat/audio_stub.c` — compile-time validation of audio struct alignment and padding across all platforms | 107 |
